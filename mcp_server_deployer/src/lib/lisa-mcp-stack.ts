...
import { EcsMcpServer } from './ecsMcpServer';
...
export class LisaMcpStack extends Stack {
    constructor (scope: Construct, id: string, props: LisaMcpStackProps) {
        ...
        // Authorizer ID is passed via environment variable and used directly in EcsMcpServer
        // The construct will use the authorizer ID to reference the existing authorizer when adding methods

        new EcsMcpServer(this, `${id}-ecsMcpServer`, {
            config: props.config,
            mcpServerConfig: props.mcpServerConfig,
            securityGroup: securityGroup,
            vpc: vpc,
            subnetSelection: subnetSelection,
            restApiId: props.restApiId,
            rootResourceId: props.rootResourceId,
            mcpResourceId: props.mcpResourceId,
        });
