...
export function ContainerConfig(props: FormProps<IContainerConfig>): ReactElement {
    return (
        <SpaceBetween size={'s'}>
            <Container header={<Header variant="h2">Memory Size & Image Config</Header>}>
                <SpaceBetween size={'s'}>
                    <FormField
            ...
            <Container header={<Header variant="h2">Container Health Check Config</Header>}>
                <SpaceBetween size={'s'}>
                    <FormField
                        label="Command"
                            ...
                            {props.item.healthCheckConfig.command.map((item, index) => (
                                ...
                                >
                                    <Input
                                        ...
                                        onChange={({ detail }) => {
                                            props.setFields({
                                                'containerConfig.healthCheckConfig.command':
                                                    props.item.healthCheckConfig.command.map((item, i) =>
                                    ...
                                    <Button
                                        ...
                                        onClick={() => {
                                            ...
                                            props.setFields({
                                                'containerConfig.healthCheckConfig.command':
                                                    props.item.healthCheckConfig.command
                                            });
                                        }}
                    ...
                    >
                        <Grid gridDefinition={[{ colspan: 10 }, { colspan: 2 }]} disableGutters={true}>
                            <Input
                                ...
                                onChange={({ detail }) => {
                                    props.setFields({
                                        'containerConfig.healthCheckConfig.interval': Number(detail.value)
                                    });
                                }}
                            />
                    ...
                    >
                        <Grid gridDefinition={[{ colspan: 10 }, { colspan: 2 }]} disableGutters={true}>
                            <Input
                                ...
                                onChange={({ detail }) => {
                                    props.setFields({
                                        'containerConfig.healthCheckConfig.startPeriod': Number(detail.value)
                                    });
                                }}
                            />
                            <span style={{ lineHeight: '2.5em', paddingLeft: '0.5em' }}>seconds</span>
                    ...
                    >
                        <Grid gridDefinition={[{ colspan: 10 }, { colspan: 2 }]} disableGutters={true}>
                            <Input
                                ...
                                onChange={({ detail }) => {
                                    props.setFields({
                                        'containerConfig.healthCheckConfig.timeout': Number(detail.value)
                                    });
                                }}
                            />
                            <span style={{ lineHeight: '2.5em', paddingLeft: '0.5em' }}>seconds</span>
            ...
            <Container header={<Header variant="h2">Container Environment</Header>}>
                <SpaceBetween size={'s'}>
                    <EnvironmentVariables
                        ...
                        propertyPath={['containerConfig', 'environment']}
                    />
                </SpaceBetween>
            </Container>
        </SpaceBetween>
