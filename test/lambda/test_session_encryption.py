...
def mock_kms():
    ...
    with mock_aws():
        ...
        key_response = kms_client.create_key(
            Description='Test session encryption key',
...
def mock_event():
    ...
    return {
        ...
        "requestContext": {
            "authorizer": {
                "claims": {
                    "cognito:username": "test-user-456"
                }
            }
        }
    }
...
class TestSessionEncryption:
    ...
    def test_encryption_error_handling(self):
        ...
        from utilities.session_encryption import SessionEncryptionError, encrypt_session_data
