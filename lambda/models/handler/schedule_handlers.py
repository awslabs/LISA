...
class UpdateScheduleHandler(ScheduleBaseHandler):
    ...
    def __call__(self, model_id: str, schedule_config: SchedulingConfig, user_groups: Optional[List[str]] = None, is_admin: bool = False) -> UpdateScheduleResponse:
...
class GetScheduleHandler(ScheduleBaseHandler):
    ...
    def __call__(self, model_id: str, user_groups: Optional[List[str]] = None, is_admin: bool = False) -> GetScheduleResponse:
...
class DeleteScheduleHandler(ScheduleBaseHandler):
    ...
    def __call__(self, model_id: str, user_groups: Optional[List[str]] = None, is_admin: bool = False) -> DeleteScheduleResponse:
...
class GetScheduleStatusHandler(ScheduleBaseHandler):
    ...
    def __call__(self, model_id: str, user_groups: Optional[List[str]] = None, is_admin: bool = False) -> GetScheduleStatusResponse:
