...
class ListModelsHandler(BaseApiHandler):
    ...
    def __call__(self, user_groups: List[str] = None, is_admin: bool = False) -> ListModelsResponse:  # type: ignore
        ...
        if not is_admin and user_groups is not None:
            models_list = [
                ...
                if self._user_has_group_access(user_groups, model.allowedGroups or [])
            ]
