...
the third party `psycopg` (psycopg3) library. The `psycopg` project's licensing includes the [LGPL 3.0](https://github.com/psycopg/psycopg/blob/master/LICENSE.txt) license.
