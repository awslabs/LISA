...
class TestRepositoryServiceFactory:
    ...
    def test_create_opensearch_service(self):
        ...
        repository = {"repositoryId": "test-repo", "type": "opensearch", "endpoint": "test.opensearch.com"}
    ...
    def test_create_pgvector_service(self):
        ...
        repository = {"repositoryId": "test-repo", "type": "pgvector", "dbHost": "localhost"}
    ...
    def test_create_service_unsupported_type(self):
        ...
        repository = {"repositoryId": "test-repo", "type": "unsupported_type"}
