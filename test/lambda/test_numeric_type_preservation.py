...
class TestNumericTypePreservation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_kms.decrypt.return_value = {
            'Plaintext': b'01234567890123456789012345678901'
        }
        ...
        self.test_session_data = {
            ...
            "history": [
                {
                    "type": "human",
                    "content": "Test message with numbers: 42 and 3.14"
                },
                {
                    "type": "assistant", 
                    "content": "Response with numeric values: 100 and 0.5"
                }
            ],
            "metadata": {
    ...
    def test_encryption_decryption_preservation(self):
        ...
        encrypted_data = encrypt_session_data(
            self.test_session_data, 
            user_id, 
            session_id
        )
        ...
        decrypted_data = decrypt_session_data(
            encrypted_data, 
            user_id, 
            session_id
        )
