...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        for model_id, model_name, litellm_params_data in models:
            ...
            has_api_key = "api_key" in litellm_params  # pragma: allowlist secret
            ...
            if has_api_key:
                print(f"🔧 Removing api_key from model: {model_name} ({model_type})")  # pragma: allowlist secret
                ...
                try:
                    ...
                    if "api_key" in clean_params:  # pragma: allowlist secret
                        ...
                        print("    Removed api_key from params")
        ...
        return {
            ...
            "Data": {"ModelsUpdated": str(models_updated)},
        }
