...
def mock_mcp_server_common():
    ...
    with patch.dict(os.environ, env_vars):
        ...
        with patch("utilities.auth.get_username") as mock_get_username, \
...
class TestGetMCPServer:
    ...
    def test_get_global_mcp_server_success(self, mcp_server_functions, mock_mcp_server_common, 
                                         dynamodb_table, sample_global_mcp_server, lambda_context):
    ...
    def test_get_mcp_server_admin_access(self, mcp_server_functions, mock_mcp_server_common,
                                        dynamodb_table, sample_mcp_server, lambda_context):
    ...
    def test_get_mcp_server_not_authorized(self, mcp_server_functions, dynamodb_table, 
                                         sample_mcp_server, lambda_context):
    ...
    def test_get_mcp_server_global_non_owner_access(self, mcp_server_functions, mock_mcp_server_common,
                                                   dynamodb_table, sample_global_mcp_server, lambda_context):
...
class TestListMCPServers:
    ...
    def test_list_mcp_servers_regular_user(self, mcp_server_functions, dynamodb_table, 
                                         sample_mcp_server, lambda_context):
    ...
    def test_list_mcp_servers_admin(self, mcp_server_functions, mock_mcp_server_common,
                                   dynamodb_table, sample_mcp_server, lambda_context):
...
class TestUpdateMCPServer:
    ...
    def test_update_mcp_server_success(self, mcp_server_functions, dynamodb_table, 
                                      sample_mcp_server, lambda_context):
    ...
    def test_update_mcp_server_admin_access(self, mcp_server_functions, mock_mcp_server_common,
                                           dynamodb_table, sample_mcp_server, lambda_context):
    ...
    def test_update_mcp_server_id_mismatch(self, mcp_server_functions, dynamodb_table, 
                                          sample_mcp_server, lambda_context):
    ...
    def test_update_mcp_server_not_authorized(self, mcp_server_functions, dynamodb_table, 
                                             sample_mcp_server, lambda_context):
    ...
    def test_update_mcp_server_invalid_json(self, mcp_server_functions, dynamodb_table, 
                                           sample_mcp_server, lambda_context):
...
class TestDeleteMCPServer:
    ...
    def test_delete_mcp_server_success(self, mcp_server_functions, dynamodb_table, 
                                      sample_mcp_server, lambda_context):
    ...
    def test_delete_mcp_server_admin_access(self, mcp_server_functions, mock_mcp_server_common,
                                           dynamodb_table, sample_mcp_server, lambda_context):
    ...
    def test_delete_mcp_server_not_authorized(self, mcp_server_functions, dynamodb_table, 
                                             sample_mcp_server, lambda_context):
