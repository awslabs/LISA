...
class TestBedrockAuthCleanup:
    ...
    def test_lambda_handler_success_no_models(
        self, mock_get_cert, mock_get_endpoint, mock_litellm_client_class, mock_boto3_client
    ):
        ...
        mock_secrets_manager.get_secret_value.return_value = {"SecretString": "test-token"}
    ...
    @patch("models.bedrock_auth_cleanup.get_rest_api_container_endpoint")
    @patch("models.bedrock_auth_cleanup.get_cert_path")
    def test_lambda_handler_success_with_bedrock_models(
        self, mock_get_cert, mock_get_endpoint, mock_litellm_client_class, mock_boto3_client
    ):
        ...
        mock_litellm_client.list_models.return_value = [
            ...
            },
            {
                ...
                "model_info": {"id": "model-2", "litellm_params": {"model": "openai/gpt-4", "api_key": "sk-123"}},
            },
        ]
        mock_litellm_client_class.return_value = mock_litellm_client
