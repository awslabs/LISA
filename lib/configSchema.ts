...
export const RagRepositoryConfigSchema = z
    .object({
        ...
        pipelines: z.array(PipelineConfigSchema).optional().default([]).describe('Rag ingestion pipeline for automated inclusion into a vector store from S3'),
