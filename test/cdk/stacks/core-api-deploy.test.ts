...
describe.each(regions)('API Core Deployment Nag Pack Tests | Region Test: %s', (awsRegion) => {
    let app: App;
    let stack: Stack;
    let config: Config;
    ...
    beforeEach(() => {
        ...
        stack = new LisaApiDeploymentStack(app, 'LisaApiDeployment', {
            ...baseStackProps,
            restApiId: tempStack.restApiId,
        });
