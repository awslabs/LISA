...
from lisa.utilities.common_functions import api_wrapper, get_item, retry_config
from lisa.utilities.exceptions import BadRequestException, ForbiddenException, NotFoundException

if TYPE_CHECKING:
    from .models import PromptTemplateModel
else:
    try:
        # When imported as a package in unit tests (`prompt_templates.lambda_functions`)
        from .models import PromptTemplateModel
