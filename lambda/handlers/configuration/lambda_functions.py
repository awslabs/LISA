...
from lisa.mcp.models import McpServerModel, McpServerStatus
from lisa.mcp.workbench import MCPWORKBENCH_UUID
from lisa.utilities.auth import is_admin
from lisa.utilities.common_functions import api_wrapper, get_property_path, retry_config
...
def check_show_mcp_workbench(body: dict[str, Any], old_configuration: dict[str, Any]) -> None:
    ...
    if old_show_mcp_value != new_show_mcp_value:
        mcp_servers_table = dynamodb.Table(os.environ["MCP_SERVERS_TABLE_NAME"])
