...
def model_api_key_cleanup_functions():
    ...
    return {"get_database_connection": get_database_connection, "lambda_handler": lambda_handler}
...
def mock_boto3_clients():
    ...
    with patch("models.model_api_key_cleanup.boto3.client") as mock_boto3_client:
        ...
        yield {"ssm_client": mock_ssm_client, "secrets_client": mock_secrets_client, "boto3_client": mock_boto3_client}
...
class TestDatabaseConnection:
    ...
    def test_get_database_connection_success(
        self, mock_model_api_key_cleanup_common, model_api_key_cleanup_functions, mock_boto3_clients
    ):
    ...
    def test_get_database_connection_secrets_error(
        self, mock_model_api_key_cleanup_common, model_api_key_cleanup_functions
    ):
