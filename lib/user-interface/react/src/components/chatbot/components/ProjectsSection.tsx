...
import { Box, Button, ButtonDropdown, FormField, Input, Modal } from '@cloudscape-design/components';
                                                ...
                                                >
                                                    <SpaceBetween direction='horizontal' size='xxs' alignItems='center'>
                                                        <Link onClick={() => onNavigate(session.sessionId)}>
                                                            ...
                                                            >
                                                                {getSessionDisplay(session, 35)}
                                                            </Box>
                                                        </Link>
                                                        <Button
                                                            iconName='close'
                                                            variant='inline-icon'
                                                            ariaLabel='Remove from project'
                                                            onClick={() => handleUnassign(session)}
                                                        />
                                                    </SpaceBetween>
                                                </Box>
                                            ))}
