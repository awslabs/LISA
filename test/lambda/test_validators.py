...
def test_validate_instance_type_valid():
    ...
    from lisa.utilities.validation import validate_instance_type
...
def test_validate_all_fields_defined_true():
    ...
    from lisa.utilities.validation import validate_all_fields_defined
...
def test_validate_any_fields_defined_true():
    ...
    from lisa.utilities.validation import validate_any_fields_defined
