...
class CollectionService:
        ...
        if collection_id:
            try:
                ...
                if collection and collection.embeddingModel:
                    return str(collection.embeddingModel)
    ...
    def list_all_user_collections(
        ...
        logger.info(
            ...
            f"sort_by={sort_params.sort_by.value}"
        )
    ...
    def _get_accessible_repositories(
        ...
        if is_admin:
            ...
            return cast(list[dict[str, Any]], all_repos)
    ...
    def _paginate_large_collections(
        ...
        merged = self._merge_sorted_batches(
            batches,
            sort_params.sort_by.value,
            sort_params.sort_order.value,
        )
