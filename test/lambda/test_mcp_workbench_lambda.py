...
def mock_mcp_workbench_common():
    ...
    with patch.dict(os.environ, env_vars):
        ...
        with patch("utilities.auth.get_username", return_value="test-user") as mock_get_username, patch(
            "mcp_workbench.lambda_functions.is_admin", return_value=False
        ) as mock_is_admin_module:
...
def mcp_workbench_functions():
    ...
    with patch("utilities.common_functions.api_wrapper", lambda func: func):
        from mcp_workbench.lambda_functions import _get_tool_from_s3, create, delete, list, MCPToolModel, read, update
...
class TestGetToolFromS3:
    ...
    def test_get_tool_from_s3_success(self, mcp_workbench_functions, mock_s3, sample_tool_content, sample_tool_id):
        ...
        with patch("mcp_workbench.lambda_functions.s3_client", mock_s3), patch(
            "mcp_workbench.lambda_functions.WORKBENCH_BUCKET", "workbench-bucket"
        ):
...
class TestReadTool:
    ...
    def test_read_success(
        self,
        mcp_workbench_functions,
        mock_mcp_workbench_common,
        mock_s3,
        sample_tool_content,
        sample_tool_id,
        lambda_context,
    ...
    def test_read_not_admin(
        self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, sample_tool_id, lambda_context
    ):
    ...
    def test_read_not_found(self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, lambda_context):
    ...
    def test_read_missing_tool_id(self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, lambda_context):
...
class TestListTools:
    ...
    def test_list_success(
        self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, sample_tool_content, lambda_context
    ):
        ...
        mock_s3.put_object(
            Bucket="workbench-bucket", Key="not_a_tool.txt", Body=b"This is not a python file", ContentType="text/plain"
        )
    ...
    def test_list_not_admin(self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, lambda_context):
    ...
    def test_list_empty_bucket(self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, lambda_context):
...
class TestCreateTool:
    ...
    def test_create_without_py_extension(
        self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, sample_tool_content, lambda_context
    ):
    ...
    def test_create_missing_fields(self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, lambda_context):
...
"""
    ...
    def test_update_not_found(self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, lambda_context):
    ...
    def test_update_missing_tool_id(self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, lambda_context):
    ...
    def test_update_missing_contents(
        self,
        mcp_workbench_functions,
        mock_mcp_workbench_common,
        mock_s3,
...
class TestDeleteTool:
    ...
    def test_delete_not_found(self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, lambda_context):
    ...
    def test_delete_missing_tool_id(self, mcp_workbench_functions, mock_mcp_workbench_common, mock_s3, lambda_context):
