...
const navLinks = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Bedrock Knowledge Base (/bedrock-kb)', link: '/config/repositories#bedrock-knowledge-base-api-reference' },
      { text: 'MCP Server Connections (/mcp-server)', link: '/config/mcp#api-reference' },
      { text: 'MCP Workbench tool management REST API (/mcp-workbench)', link: '/config/mcp-workbench#api-reference' },
      { text: 'Prompt Templates (/prompt-templates)', link: '/config/prompt-templates#api-reference' },
      { text: 'Session (/session)', link: '/config/session#api-reference' },
      { text: 'User Preferences (/user-preferences)', link: '/config/user-preferences#api-reference' },
    ],
  },
];
