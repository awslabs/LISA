...
def constants_module():
    ...
    return {"PDF_FILE": PDF_FILE, "TEXT_FILE": TEXT_FILE, "DOCX_FILE": DOCX_FILE}
...
class TestConstants:
    ...
    def test_constants_uniqueness(self, mock_constants_common, constants_module):
        ...
        constants_values = [constants_module["PDF_FILE"], constants_module["TEXT_FILE"], constants_module["DOCX_FILE"]]
...
class TestConstantsUsage:
    ...
    def test_constants_can_be_used_in_collections(self, mock_constants_common, constants_module):
        ...
        supported_types = [constants_module["PDF_FILE"], constants_module["TEXT_FILE"], constants_module["DOCX_FILE"]]
